#!/usr/bin/env bash
# 🔍 Ovi — Research & Intel
# Market research, competitor analysis, trend scouting, weekly reports.
set -euo pipefail
...
case "$CMD" in
  ...
  comment)
    ...
    CARD_ID=$(trello_find_card "$TITLE")
    trello_comment_card "$CARD_ID" "🔍 Ovi: $TEXT"
